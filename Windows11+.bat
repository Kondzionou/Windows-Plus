...
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps4.ps1
start %~dp0\%~n0%~x0
exit
...
::Office etc.
:offices
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps5.ps1
start %~dp0\%~n0%~x0
exit

::Solitare
:solitarec
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps6.ps1
start %~dp0\%~n0%~x0
exit

::boooooost ssd
:bssd
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps7.ps1
start %~dp0\%~n0%~x0
exit

::alarmy
:aclock
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps8.ps1
start %~dp0\%~n0%~x0
exit

::Phone
:phone
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps9.ps1
start %~dp0\%~n0%~x0
exit

::feedback
:feedback
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps10.ps1
start %~dp0\%~n0%~x0
exit

::bing
:bing
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps11.ps1
start %~dp0\%~n0%~x0
exit

::dyktafon
:dyktafon
Powershell.exe -executionpolicy remotesigned -File  %~dp0\ps\ps12.ps1
start %~dp0\%~n0%~x0
exit
